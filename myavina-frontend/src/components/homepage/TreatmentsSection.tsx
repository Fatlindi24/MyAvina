  ...
  <div>
    ...
    <div className="mt-4 bg-[#F8F1FF] p-4 rounded-[15px]">
      <div className="flex justify-between items-center">
        <h3 className="text-[16px] font-medium text-gray-900">{product.name}</h3>
        <p className="text-[14px] text-[#828282]">${product.price}/month</p>
      </div>
      <div className="flex justify-between items-center mt-2 text-sm">
        <span className='text-[12px] text-[#828282]'>{product.rating} ({product.reviews.toLocaleString()})</span>
...
export const TreatmentsSection = () => {
        ...
        <section className="bg-white">
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center mb-10">
                    ...
                    <a href="#" className="hidden text-[16px] text-400 sm:inline-block bg-black text-white  px-5 py-3 rounded-full hover:bg-gray-800 transition-colors">
                        Shop All Treatments
                    </a>
                </div>
    ...
    <SwiperNavButtons />
                 ...
                 <a  href="#" className="mb-10 block w-full text-center lg:hidden text-[16px] font-normal bg-black text-white px-5 py-3 rounded-full hover:bg-gray-800 transition-colors">
  Shop All Treatments
</a>
