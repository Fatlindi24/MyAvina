...
const SectionOne = () => {
    return (
        <div>
            <div className="mx-auto px-4 pt-16 max-w-[1400px] grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                ...
                <div className="space-y-6 max-w-md">
                    <p className="text-lg text-gray-700">
                        We created MyAvina to bring clarity, compassion, and science-backed care to women navigating perimenopause,
            ...
            <div className="mt-12 mx-auto px-4 max-w-[1400px]">
